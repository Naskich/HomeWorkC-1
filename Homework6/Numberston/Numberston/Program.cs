...
namespace MinMaxSumAverageofN
{
    class Program
    {
        static void Main()
        {
            ...
            if (input2 < input4 && input4 < input1 && input2 > input3)
                Console.WriteLine("max = {0} and min = {1}", input1, input3);
            if (input2 < input3 && input3 < input1 && input2 > input4)
                Console.WriteLine("max = {0} and min = {1}", input1, input4);
            if (input1 < input2 && input2 < input4 && input1 > input3)
                Console.WriteLine("max = {0} and min = {1}", input4, input3);
            if (input1 < input4 && input4 < input2 && input1 > input3)
                Console.WriteLine("max = {0} and min = {1}", input2, input3);
            if (input1 < input3 && input3 < input2 && input1 > input4)
                Console.WriteLine("max = {0} and min = {1}", input2, input4);
            if (input4 < input1 && input1 < input3 && input4 > input2)
                Console.WriteLine("max = {0} and min = {1}", input3, input2);
            if (input2 < input1 && input1 < input3 && input2 > input4)
                Console.WriteLine("max = {0} and min = {1}", input3, input4);
            Console.WriteLine();
        }
    }
}
